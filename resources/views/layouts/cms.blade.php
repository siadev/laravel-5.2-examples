...
<section id="container" class="">
    ...
    <header class="header dark-bg">
        ...
        <!--logo start-->
        <a href="/cms" class="logo">SIADEV<span class="lite">Admin</span></a>
        <!--logo end-->
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li id="mail_notification_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="/img/cms/avatar-mini.jpg"></span>
                                    <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="/img/cms/avatar-mini2.jpg"></span>
                                    <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="/img/cms/avatar-mini3.jpg"></span>
                                    <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="/img/cms/avatar-mini4.jpg"></span>
                                    <span class="subject">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="img/cms/avatar1_small.jpg">
                            </span>
